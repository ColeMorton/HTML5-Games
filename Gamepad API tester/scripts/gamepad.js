...
var gamepadSupport = {
  ...
  pollStatus: function() {
    ...
    for (var i in gamepadSupport.gamepads) {
      ...
      gamepadSupport.updateDisplayCole(i);
    }
  },
  ...
  updateDisplay: function(gamepadId) {
    ...
    tester.updateButtonCole(gamepad.buttons[6], gamepadId,
        'button-left-shoulder-bottom');
    ...
    //Coles
    tester.updateAxis1Cole(gamepad.axes[1], gamepadId,
        'stick-1-axis-y', 'stick-1', true);
    tester.updateAxis2Cole(gamepad.axes[3], gamepadId,
        'stick-2-axis-y', 'stick-1', false);
  ...
  updateDisplayCole: function(gamepadId) {
    console.log("");
    console.log(tester.EVENT_LIST);
  }
};
