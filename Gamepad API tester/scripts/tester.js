...
var tester = {
  ...
  updateAxis1Cole: function(value, gamepadId, labelId, stickId, horizontal) {
    // console.log("");
    // console.log(value);
  ...
  updateAxis2Cole: function(value, gamepadId, labelId, stickId, horizontal) {
    // console.log("");
    // console.log(value);
    // console.log(gamepadId);
    // console.log(labelId);
    ...
    if (value < -0.05) {
      tester.rightFrontHit();
    }
  },

  updateButtonCole: function(button, gamepadId, id) {
    // console.log("");
    // console.log(button);
    // console.log(gamepadId);
    // console.log(id);

    if (id === "button-left-shoulder-bottom" && button.value > 0.95) {
      tester.EVENT_LIST.push("left-lift");
    }
  },

  rightFrontHit: function() {
    eventName = "right-front";
    if (tester.EVENT_LIST[tester.eventListTotal() - 1] != eventName) {
      tester.EVENT_LIST.push(eventName);
    }
  },

  leftBackHit: function() {
    eventName = "left-back";
    if (tester.EVENT_LIST[tester.eventListTotal() - 1] != eventName) {
      tester.EVENT_LIST.push(eventName);
    }
  ...
  eventListTotal: function() {
    return tester.EVENT_LIST.length;
  }
};
